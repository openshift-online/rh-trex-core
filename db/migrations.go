...
// DatabaseConfig represents minimal database configuration
...
// Extended SessionFactory interface that includes connection management
type ExtendedSessionFactory interface {
	SessionFactory
